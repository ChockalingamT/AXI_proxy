...
leon3-soft: $(SOFT_BUILD)/prom.srec $(SOFT_BUILD)/ram.srec $(SOFT_BUILD)/ram.vhx8
...
$(SOFT_BUILD)/ram.vhx8: $(TEST_PROGRAM)
	$(QUIET_OBJCP)$(CROSS_COMPILE_ELF)objcopy -O verilog $< $@
	python3 $(ESP_ROOT)/utils/scripts/srec/create_vhx.py $@ > $(SOFT_BUILD)/ram.vhx
	rm $@
